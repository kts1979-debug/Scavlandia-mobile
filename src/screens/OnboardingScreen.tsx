...
const SLIDES = [
  ...
  },
  {
    ...
    body: 'The Home tab is where you start every adventure. Tap "Start a Hunt" to choose your hunt type and build your personalized experience. You\'ll also find a quick overview of how Scavlandia works.',
    color: "#1A6B8A",
  },
  {
    id: "3",
    ...
    body: "The Past Hunts tab keeps a record of every adventure you've completed. Tap any hunt to see the stops you visited, clues you solved, fun facts you discovered, and photos you took along the way.",
    color: "#2E4057",
  },
  {
    id: "4",
    ...
    body: "The Profile tab shows your stats, achievements, and account settings. See how many cities you've explored, total points earned, and manage your subscription.",
    color: "#1A5276",
  },
  {
    id: "5",
  ...
  },
  {
    ...
    body: '1️⃣  Tap "Start a Hunt" on the Home screen\n\n2️⃣  Choose your hunt type — City, Museum, or Micro\n\n3️⃣  Tell us about your group and we\'ll build your personalized adventure in about 30 seconds',
    color: "#1A5276",
  },
  {
    id: "9",
